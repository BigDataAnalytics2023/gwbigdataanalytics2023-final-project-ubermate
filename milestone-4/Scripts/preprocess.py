...
while True:
    ...
    if dataframes:
        ...
        #if any new data was added into Hive, signal file will be updated with current date and time to signal kmean to run
    ...
    #Script stops when no more new_files, which means all files are processed in this dir
    if not new_files:
        for i in range(10):
